...
function draw() {
    ...
    {
    	circle(30+26,30+26,16);
    }
    if(pos1[2]==2 && pos1[0]==0)
    {
        circle(82+26,30+26,16);
    }
    if(pos1[3]==2 && pos1[0]==0)
    {
        circle(134+26,30+26,16);
    }
    if(pos1[4]==2 && pos1[0]==0)
    {
        circle(30+26,82+26,16);
    }
    if(pos1[5]==2 && pos1[0]==0)
    {
        circle(82+26,82+26,16);
    }
    if(pos1[6]==2 && pos1[0]==0)
    {
        circle(134+26,82+26,16);
    }
    if(pos1[7]==2 && pos1[0]==0)
    {
        circle(30+26,134+26,16);
    }
    if(pos1[8]==2 && pos1[0]==0)
    {
        circle(82+26,134+26,16);
    }
    if(pos1[9]==2 && pos1[0]==0)
    {
        circle(134+26,134+26,16);
    }
                                //  pos2
    if(pos2[1]==2 && pos2[0]==0)
    {
    	circle(215+26,30+26,16);
    }
    if(pos2[2]==2 && pos2[0]==0)
    {
        circle(267+26,30+26,16);
    }
    if(pos2[3]==2 && pos2[0]==0)
    {
        circle(319+26,30+26,16);
    }
    if(pos2[4]==2 && pos2[0]==0)
    {
        circle(215+26,82+26,16);
    }
    if(pos2[5]==2 && pos2[0]==0)
    {
        circle(267+26,82+26,16);
    }
    if(pos2[6]==2 && pos2[0]==0)
    {
        circle(319+26,82+26,16);
    }
    if(pos2[7]==2 && pos2[0]==0)
    {
        circle(215+26,134+26,16);
    }
    if(pos2[8]==2 && pos2[0]==0)
    {
        circle(267+26,134+26,16);
    }
    if(pos2[9]==2 && pos2[0]==0)
    {
        circle(319+26,134+26,16);
    }
                                //  pos3
    if(pos3[1]==2 && pos3[0]==0)
    {
    	circle(400+26,30+26,16);
    }
    if(pos3[2]==2 && pos3[0]==0)
    {
        circle(452+26,30+26,16);
    }
    if(pos3[3]==2 && pos3[0]==0)
    {
        circle(504+26,30+26,16);
    }
    if(pos3[4]==2 && pos3[0]==0)
    {
        circle(400+26,82+26,16);
    }
    if(pos3[5]==2 && pos3[0]==0)
    {
        circle(450+26,82+26,16);
    }
    if(pos3[6]==2 && pos3[0]==0)
    {
        circle(504+26,82+26,16);
    }
    if(pos3[7]==2 && pos3[0]==0)
    {
        circle(400+26,134+26,16);
    }
    if(pos3[8]==2 && pos3[0]==0)
    {
        circle(452+26,134+26,16);
    }
    if(pos3[9]==2 && pos3[0]==0)
    {
        circle(504+26,134+26,16);
    }
                                //  pos4
    if(pos4[1]==2 && pos4[0]==0)
    {
    	circle(30+26,215+26,16);
    }
    if(pos4[2]==2 && pos4[0]==0)
    {
        circle(82+26,215+26,16);
    }
    if(pos4[3]==2 && pos4[0]==0)
    {
        circle(134+26,215+26,16);
    }
    if(pos4[4]==2 && pos4[0]==0)
    {
        circle(30+26,267+26,16);
    }
    if(pos4[5]==2 && pos4[0]==0)
    {
        circle(82+26,267+26,16);
    }
    if(pos4[6]==2 && pos4[0]==0)
    {
        circle(134+26,267+26,16);
    }
    if(pos4[7]==2 && pos4[0]==0)
    {
        circle(30+26,319+26,16);
    }
    if(pos4[8]==2 && pos4[0]==0)
    {
        circle(82+26,319+26,16);
    }
    if(pos4[9]==2 && pos4[0]==0)
    {
        circle(134+26,319+26,16);
    }
                                //  pos5
    if(pos5[1]==2 && pos5[0]==0)
    {
    	circle(215+26,215+26,16);
    }
    if(pos5[2]==2 && pos5[0]==0)
    {
        circle(267+26,215+26,16);
    }
    if(pos5[3]==2 && pos5[0]==0)
    {
        circle(319+26,215+26,16);
    }
    if(pos5[4]==2 && pos5[0]==0)
    {
        circle(215+26,267+26,16);
    }
    if(pos5[5]==2 && pos5[0]==0)
    {
        circle(267+26,267+26,16);
    }
    if(pos5[6]==2 && pos5[0]==0)
    {
        circle(319+26,267+26,16);
    }
    if(pos5[7]==2 && pos5[0]==0)
    {
        circle(215+26,319+26,16);
    }
    if(pos5[8]==2 && pos5[0]==0)
    {
        circle(267+26,319+26,16);
    }
    if(pos5[9]==2 && pos5[0]==0)
    {
        circle(319+26,319+26,16);
    }
                                //  pos6
    if(pos6[1]==2 && pos6[0]==0)
    {
    	circle(400+26,215+26,16);
    }
    if(pos6[2]==2 && pos6[0]==0)
    {
        circle(452+26,215+26,16);
    }
    if(pos6[3]==2 && pos6[0]==0)
    {
        circle(504+26,215+26,16);
    }
    if(pos6[4]==2 && pos6[0]==0)
    {
        circle(400+26,267+26,16);
    }
    if(pos6[5]==2 && pos6[0]==0)
    {
        circle(450+26,267+26,16);
    }
    if(pos6[6]==2 && pos6[0]==0)
    {
        circle(504+26,267+26,16);
    }
    if(pos6[7]==2 && pos6[0]==0)
    {
        circle(400+26,319+26,16);
    }
    if(pos6[8]==2 && pos6[0]==0)
    {
        circle(452+26,319+26,16);
    }
    if(pos6[9]==2 && pos6[0]==0)
    {
        circle(504+26,319+26,16);
    }
                                //  pos7
    if(pos7[1]==2 && pos7[0]==0)
    {
    	circle(30+26,400+26,16);
    }
    if(pos7[2]==2 && pos7[0]==0)
    {
        circle(82+26,400+26,16);
    }
    if(pos7[3]==2 && pos7[0]==0)
    {
        circle(134+26,400+26,16);
    }
    if(pos7[4]==2 && pos7[0]==0)
    {
        circle(30+26,452+26,16);
    }
    if(pos7[5]==2 && pos7[0]==0)
    {
        circle(82+26,452+26,16);
    }
    if(pos7[6]==2 && pos7[0]==0)
    {
        circle(134+26,452+26,16);
    }
    if(pos7[7]==2 && pos7[0]==0)
    {
        circle(30+26,504+26,16);
    }
    if(pos7[8]==2 && pos7[0]==0)
    {
        circle(82+26,504+26,16);
    }
    if(pos7[9]==2 && pos7[0]==0)
    {
        circle(134+26,504+26,16);
    }
                                //  pos8
    if(pos8[1]==2 && pos8[0]==0)
    {
    	circle(215+26,400+26,16);
    }
    if(pos8[2]==2 && pos8[0]==0)
    {
        circle(267+26,400+26,16);
    }
    if(pos8[3]==2 && pos8[0]==0)
    {
        circle(319+26,400+26,16);
    }
    if(pos8[4]==2 && pos8[0]==0)
    {
        circle(215+26,452+26,16);
    }
    if(pos8[5]==2 && pos8[0]==0)
    {
        circle(267+26,452+26,16);
    }
    if(pos8[6]==2 && pos8[0]==0)
    {
        circle(319+26,452+26,16);
    }
    if(pos8[7]==2 && pos8[0]==0)
    {
        circle(215+26,504+26,16);
    }
    if(pos8[8]==2 && pos8[0]==0)
    {
        circle(267+26,504+26,16);
    }
    if(pos8[9]==2 && pos8[0]==0)
    {
        circle(319+26,504+26,16);
    }
                                //  pos9
    if(pos9[1]==2 && pos9[0]==0)
    {
    	circle(400+26,400+26,16);
    }
    if(pos9[2]==2 && pos9[0]==0)
    {
        circle(452+26,400+26,16);
    }
    if(pos9[3]==2 && pos9[0]==0)
    {
        circle(504+26,400+26,16);
    }
    if(pos9[4]==2 && pos9[0]==0)
    {
        circle(400+26,452+26,16);
    }
    if(pos9[5]==2 && pos9[0]==0)
    {
        circle(450+26,452+26,16);
    }
    if(pos9[6]==2 && pos9[0]==0)
    {
        circle(504+26,452+26,16);
    }
    if(pos9[7]==2 && pos9[0]==0)
    {
        circle(400+26,504+26,16);
    }
    if(pos9[8]==2 && pos9[0]==0)
    {
        circle(452+26,504+26,16);
    }
    if(pos9[9]==2 && pos9[0]==0)
    {
        circle(504+26,504+26,16);
    }
